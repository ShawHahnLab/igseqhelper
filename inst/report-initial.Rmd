...
counts_stats <- within(list(), {
  by_sample <- load_csv_maybe(file.path(ROOT, "analysis/reporting/counts_by_sample.csv"), NA)
  by_sample <- subset(by_sample, Sample != "unassigned")
  by_run <- load_csv_maybe(file.path(ROOT, "analysis/reporting/counts_by_run.csv"))
  by_amplicon <- load_csv_maybe(file.path(ROOT, "analysis/reporting/counts_amplicon_summary.csv"), NA)
  assembly <- load_csv_maybe(file.path(ROOT, "analysis/reporting/counts_assembly_summary.csv"), NA)
  qual <- load_csv_maybe(file.path(ROOT, "analysis/reporting/counts_presto_qual_summary.csv"), NA)
  sonar <- load_csv_maybe(file.path(ROOT, "analysis/reporting/counts_sonar_module1_summary.csv"), NA)
})
```
