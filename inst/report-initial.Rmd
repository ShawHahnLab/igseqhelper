...
counts_stats <- within(list(), {
  by_sample <- load_csv(file.path(ROOT, "reporting/counts_by_sample.csv"))
  by_sample <- subset(by_sample, Sample != "unassigned")
  by_run <- load_csv(file.path(ROOT, "reporting/counts_by_run.csv"))
  by_amplicon <- load_csv(file.path(ROOT, "reporting/counts_amplicon_summary.csv"))
  assembly <- load_csv(file.path(ROOT, "reporting/counts_assembly_summary.csv"))
  qual <- load_csv(file.path(ROOT, "reporting/counts_presto_qual_summary.csv"))
})
```
...
```{r}
drawtab(counts_stats$by_amplicon)
```
